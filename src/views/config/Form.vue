    ...
    >
      ...
      <el-row :gutter="10">
        <el-col :md="21" :sm="21" :xs="21">
          <el-form-item prop="machine_id">
            <template #label>
              {{ t('easytier.machine_id') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :md="24" :sm="12" :xs="12">
          <el-form-item prop="mapped_listeners">
            <template #label>
              {{ t('easytier.mapped_listeners') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="proxy_network.cidr">
            <template #label>
      ...
      <el-row>
        <el-col :md="12" :sm="12" :xs="12">
          <el-form-item prop="vpn_portal_config.client_cidr">
            <template #label>
              {{ t('easytier.vpn_client_cidr') }}
              <el-tooltip
                trigger="hover"
        ...
        <el-col :md="12" :sm="12" :xs="12">
          <el-form-item prop="vpn_portal_config.wireguard_listen" label-width="45%">
            <template #label>
              {{ t('easytier.vpn_wireguard_listen') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="stun_servers">
            <template #label>
              {{ t('easytier.stun_servers') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="stun_servers_v6">
            <template #label>
              {{ t('easytier.stun_servers_v6') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="rpc_portal_whitelist">
            <template #label>
              {{ t('easytier.rpc_portal_whitelist') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="socks5_proxy">
            <template #label>
              {{ t('easytier.socks5_proxy') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="rpc_portal">
            <template #label>
              {{ t('easytier.rpc_portal') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="file_logger.size">
            <template #label>
              {{ t('easytier.file_log_size') }}
              <el-tooltip
                trigger="hover"
        ...
        <el-col :span="12">
          <el-form-item prop="file_logger.count">
            <template #label>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="flags.default_protocol">
            <template #label>
        ...
        <el-col :span="12">
          <el-form-item prop="flags.dev_name">
            <template #label>
              {{ t('easytier.dev_name') }}
      ...
      <el-row :span="24">
        <el-col :span="12">
          <el-form-item prop="flags.latency_first">
            <template #label>
              {{ t('easytier.latency_first') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item prop="flags.encryption_algorithm">
            <template #label>
              {{ t('easytier.encryption_algorithm') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item prop="flags.multi_thread_count">
            <template #label>
              {{ t('easytier.multi_thread_count') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="flags.bind_device">
            <template #label>
              {{ t('easytier.bind_device') }}
              <el-tooltip
                trigger="hover"
        ...
        <el-col :span="12">
          <el-form-item prop="flags.disable_tcp_hole_punching">
            <template #label>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="flags.enable_kcp_proxy">
            <template #label>
              {{ t('easytier.enable_kcp_proxy') }}
              <el-tooltip
                trigger="hover"
        ...
        <el-col :span="12">
          <el-form-item prop="flags.disable_kcp_input">
            <template #label>
              {{ t('easytier.disable_kcp_input') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="flags.enable_quic_proxy">
            <template #label>
              {{ t('easytier.enable_quic_proxy') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item prop="flags.disable_sym_hole_punching">
            <template #label>
              {{ t('easytier.disable_sym_hole_punching') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="flags.no_tun">
            <template #label>
              {{ t('easytier.no_tun') }}
              <el-tooltip
                trigger="hover"
        ...
        <el-col :span="12">
          <el-form-item prop="flags.use_smoltcp">
            <template #label>
              {{ t('easytier.use_smoltcp') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="flags.disable_p2p">
            <template #label>
              {{ t('easytier.disable_p2p') }}
              <el-tooltip
                trigger="hover"
        ...
        <el-col :span="12">
          <el-form-item prop="flags.disable_udp_hole_punching">
            <template #label>
              {{ t('easytier.disable_udp_hole_punching') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="flags.p2p_only">
            <template #label>
              {{ t('easytier.p2p_only') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item prop="flags.relay_all_peer_rpc">
            <template #label>
              {{ t('easytier.relay_all_peer_rpc') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="flags.accept_dns">
            <template #label>
              {{ t('easytier.accept_dns') }}
              <el-tooltip
                trigger="hover"
        ...
        <el-col :span="12">
          <el-form-item prop="flags.private_mode">
            <template #label>
              {{ t('easytier.private_mode') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item prop="flags.proxy_forward_by_system">
            <template #label>
              {{ t('easytier.proxy_forward_by_system') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="flags.relay_network_whitelist">
            <template #label>
              {{ t('easytier.relay_network_whitelist') }}
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="flags.foreign_relay_bps_limit">
            <template #label>
              {{ t('easytier.foreign_relay_bps_limit') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="flags.socks5">
            <template #label>
              {{ t('easytier.socks5') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item prop="flags.tld_dns_zone">
            <template #label>
              {{ t('easytier.tld_dns_zone') }}
              <el-tooltip
                trigger="hover"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item prop="tcp_whitelist">
            <template #label>
              {{ t('easytier.tcp_whitelist') }}
              <el-tooltip
                trigger="hover"
        ...
        <el-col :span="12">
          <el-form-item prop="udp_whitelist">
            <template #label>
              {{ t('easytier.udp_whitelist') }}
              <el-tooltip
                trigger="hover"
